...
function ChatBot() {
  ...
  const handleNewUserMessage = (newMessage) => {
    ...
    } else if (lowerCaseMessage === "i'm feeling lonely") {
      addResponseMessage(
    ...
    } else if (lowerCaseMessage === "i am having a hard time taking care of my patients") {
      addResponseMessage(
    ...
    } else if (lowerCaseMessage === "i'm feeling stressed") {
      addResponseMessage(
    ...
    } else if (lowerCaseMessage === "thank you") {
